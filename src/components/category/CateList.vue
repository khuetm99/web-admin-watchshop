      ...
      >
        ...
        <tbody class="mdc-data-table__content">
          <tr
            ...
            v-for="(cate, index) in cateListData"
            :key="cate.id"
          >
            <td
            ...
            >
              ...
              <button
                @click="submitdeleteCate(cate.cateId, index)"
                class="mdc-button mdc-button--raised"
...
export default {
  ...
  setup(props, { emit }) {
    const { cateListData, cateListStatus, getCateList, deleteCate } = useCate();
    ...
    const submitdeleteCate = (cateId, index) => {
      cateListData.value.splice(index , 1);
      deleteCate(cateId);
    }
